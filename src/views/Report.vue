    ...
    .reportWrapper(ref="print")
      .pdf(ref="pdf")
        ...
        .reportWrapper-commonpage.pageSetting
          ...
          p [Freshwater is a precious and scarce natural resource, therefore, we are conscious to adopt water-saving measures at our properties. During the reporting year, total water consumed is [system auto-generated number, eg. 186m3] and total water consumed by intensity is [system auto-calculated by dividing GFA as mentioned in above comment box].  Besides, our company also supports the procurement department to source more sustainable solutions across different areas, from sustainable seafood to products that have less packaging. Total packaging material used during the reporting year is [1.8 tonnes] for [120000 units] produced. ]
